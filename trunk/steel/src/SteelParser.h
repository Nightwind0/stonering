...
public:
    ...
    struct ParseNonterminal
    {
        ...
        enum Name
        {
            ...
            func_definition = 309,
            func_identifier = 340,
            hashmap_identifier = 344,
            int_literal = 335,
            optionalexp = 329,
            pair = 325,
            pair_list = 323,
            param_definition = 316,
            param_id = 311,
            param_list = 351,
            root = 0,
            statement = 327,
...
private:
    ...
    struct Nonterminal_
    {
        enum Name
        {
            ...
            var_identifier = 327,
            func_identifier = 328,
            array_identifier = 329,
            hashmap_identifier = 330,
            call = 331,
            vardecl = 332,
            param_list = 333
