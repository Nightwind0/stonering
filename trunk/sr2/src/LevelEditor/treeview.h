...
#ifndef srheader_treeview
#define srheader_treeview
...
//- !group=GUI/Controls!
//- !header=gui.h!
class SR_TreeView : public CL_Component, public SR_TreeNode
{
//! Construction:
public:
...
//! Implementation:
private:
	SR_TreeView(const SR_TreeView &copy) : CL_Component(NULL, NULL), SR_TreeNode(NULL, NULL) { return; } // disallow copy construction.
	SR_TreeView_Generic *impl;
};
