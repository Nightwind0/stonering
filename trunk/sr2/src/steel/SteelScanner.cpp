...
// SteelScanner.cpp generated by reflex at Fri Jan 19 11:52:43 2007
...
SteelScanner::Transition const SteelScanner::ms_transition[] =
{
    ...
    { Transition::TT_INPUT_ATOM, 9, 9, ms_state+42 },
    { Transition::TT_INPUT_ATOM, 32, 32, ms_state+42 },
    { Transition::TT_INPUT_ATOM, 34, 34, ms_state+4 },
    { Transition::TT_INPUT_ATOM, 45, 45, ms_state+43 },
    { Transition::TT_INPUT_ATOM, 43, 43, ms_state+44 },
    { Transition::TT_INPUT_ATOM, 48, 48, ms_state+7 },
    { Transition::TT_INPUT_ATOM_RANGE, 49, 57, ms_state+45 },
    { Transition::TT_INPUT_ATOM, 48, 48, ms_state+47 },
    { Transition::TT_INPUT_ATOM_RANGE, 48, 57, ms_state+51 },
    { Transition::TT_INPUT_ATOM, 36, 36, ms_state+54 },
    { Transition::TT_INPUT_ATOM, 64, 64, ms_state+57 },
    { Transition::TT_INPUT_ATOM, 59, 59, ms_state+12 },
    { Transition::TT_INPUT_ATOM, 123, 123, ms_state+12 },
    { Transition::TT_INPUT_ATOM, 125, 125, ms_state+12 },
    { Transition::TT_INPUT_ATOM, 64, 64, ms_state+13 },
    { Transition::TT_END_OF_LINE, 0, 0, ms_state+13 },
    { Transition::TT_INPUT_ATOM, 40, 40, ms_state+13 },
    { Transition::TT_INPUT_ATOM, 41, 41, ms_state+13 },
    { Transition::TT_INPUT_ATOM, 44, 44, ms_state+13 },
    { Transition::TT_INPUT_ATOM, 37, 37, ms_state+13 },
    { Transition::TT_INPUT_ATOM, 43, 43, ms_state+13 },
    { Transition::TT_INPUT_ATOM, 45, 45, ms_state+13 },
    { Transition::TT_INPUT_ATOM, 94, 94, ms_state+13 },
    { Transition::TT_INPUT_ATOM, 42, 42, ms_state+13 },
    { Transition::TT_INPUT_ATOM, 61, 61, ms_state+13 },
    { Transition::TT_INPUT_ATOM, 91, 91, ms_state+13 },
    { Transition::TT_INPUT_ATOM, 93, 93, ms_state+13 },
    { Transition::TT_INPUT_ATOM, 37, 37, ms_state+13 },
    { Transition::TT_INPUT_ATOM, 47, 47, ms_state+13 },
    { Transition::TT_INPUT_ATOM, 60, 60, ms_state+60 },
    { Transition::TT_INPUT_ATOM, 62, 62, ms_state+61 },
    { Transition::TT_INPUT_ATOM, 33, 33, ms_state+62 },
    { Transition::TT_INPUT_ATOM, 61, 61, ms_state+63 },
    { Transition::TT_INPUT_ATOM, 60, 60, ms_state+18 },
    { Transition::TT_INPUT_ATOM, 62, 62, ms_state+19 },
    { Transition::TT_INPUT_ATOM, 100, 100, ms_state+20 },
    { Transition::TT_INPUT_ATOM, 97, 97, ms_state+64 },
    { Transition::TT_INPUT_ATOM, 111, 111, ms_state+66 },
    { Transition::TT_INPUT_ATOM, 110, 110, ms_state+67 },
    { Transition::TT_INPUT_ATOM, 119, 119, ms_state+69 },
    { Transition::TT_INPUT_ATOM, 102, 102, ms_state+73 },
    { Transition::TT_INPUT_ATOM, 98, 98, ms_state+75 },
    { Transition::TT_INPUT_ATOM, 99, 99, ms_state+79 },
    { Transition::TT_INPUT_ATOM, 105, 105, ms_state+86 },
    { Transition::TT_INPUT_ATOM, 101, 101, ms_state+87 },
    { Transition::TT_INPUT_ATOM, 114, 114, ms_state+90 },
    { Transition::TT_INPUT_ATOM, 102, 102, ms_state+95 },
    { Transition::TT_INPUT_ATOM, 118, 118, ms_state+102 },
    { Transition::TT_INPUT_ATOM_RANGE, 65, 90, ms_state+104 },
    { Transition::TT_INPUT_ATOM, 95, 95, ms_state+104 },
    { Transition::TT_INPUT_ATOM_RANGE, 97, 122, ms_state+104 },
    { Transition::TT_INPUT_ATOM, 47, 47, ms_state+40 },
    { Transition::TT_EPSILON, 0, 0, ms_state+41 },
    { Transition::TT_INPUT_ATOM_RANGE, 0, 9, ms_state+41 },
    { Transition::TT_INPUT_ATOM_RANGE, 11, 255, ms_state+41 },
    { Transition::TT_EPSILON, 0, 0, ms_state+2 },
    { Transition::TT_INPUT_ATOM, 9, 9, ms_state+42 },
    { Transition::TT_INPUT_ATOM, 32, 32, ms_state+42 },
    { Transition::TT_EPSILON, 0, 0, ms_state+3 },
    { Transition::TT_INPUT_ATOM, 45, 45, ms_state+5 },
    { Transition::TT_INPUT_ATOM, 43, 43, ms_state+6 },
    { Transition::TT_EPSILON, 0, 0, ms_state+46 },
    { Transition::TT_INPUT_ATOM_RANGE, 48, 57, ms_state+46 },
    { Transition::TT_EPSILON, 0, 0, ms_state+7 },
    { Transition::TT_INPUT_ATOM, 120, 120, ms_state+48 },
    { Transition::TT_INPUT_ATOM_RANGE, 48, 57, ms_state+49 },
    { Transition::TT_INPUT_ATOM_RANGE, 65, 70, ms_state+49 },
    { Transition::TT_INPUT_ATOM_RANGE, 97, 102, ms_state+49 },
    { Transition::TT_INPUT_ATOM_RANGE, 48, 57, ms_state+49 },
    { Transition::TT_INPUT_ATOM_RANGE, 65, 70, ms_state+49 },
    { Transition::TT_INPUT_ATOM_RANGE, 97, 102, ms_state+49 },
    { Transition::TT_EPSILON, 0, 0, ms_state+8 },
    { Transition::TT_INPUT_ATOM, 46, 46, ms_state+52 },
    { Transition::TT_INPUT_ATOM_RANGE, 48, 57, ms_state+51 },
    ...
    { Transition::TT_INPUT_ATOM_RANGE, 65, 90, ms_state+58 },
    { Transition::TT_INPUT_ATOM, 95, 95, ms_state+58 },
    { Transition::TT_INPUT_ATOM_RANGE, 97, 122, ms_state+58 },
    { Transition::TT_EPSILON, 0, 0, ms_state+59 },
    { Transition::TT_INPUT_ATOM_RANGE, 48, 57, ms_state+59 },
    ...
    { Transition::TT_INPUT_ATOM, 110, 110, ms_state+65 },
    { Transition::TT_INPUT_ATOM, 100, 100, ms_state+21 },
    { Transition::TT_INPUT_ATOM, 114, 114, ms_state+22 },
    { Transition::TT_INPUT_ATOM, 111, 111, ms_state+68 },
    { Transition::TT_INPUT_ATOM, 116, 116, ms_state+23 },
    { Transition::TT_INPUT_ATOM, 104, 104, ms_state+70 },
    { Transition::TT_INPUT_ATOM, 105, 105, ms_state+71 },
    { Transition::TT_INPUT_ATOM, 108, 108, ms_state+72 },
    { Transition::TT_INPUT_ATOM, 101, 101, ms_state+24 },
    { Transition::TT_INPUT_ATOM, 111, 111, ms_state+74 },
    { Transition::TT_INPUT_ATOM, 114, 114, ms_state+25 },
    { Transition::TT_INPUT_ATOM, 114, 114, ms_state+76 },
    { Transition::TT_INPUT_ATOM, 101, 101, ms_state+77 },
    { Transition::TT_INPUT_ATOM, 97, 97, ms_state+78 },
    { Transition::TT_INPUT_ATOM, 107, 107, ms_state+26 },
    { Transition::TT_INPUT_ATOM, 111, 111, ms_state+80 },
    { Transition::TT_INPUT_ATOM, 110, 110, ms_state+81 },
    { Transition::TT_INPUT_ATOM, 116, 116, ms_state+82 },
    { Transition::TT_INPUT_ATOM, 105, 105, ms_state+83 },
    { Transition::TT_INPUT_ATOM, 110, 110, ms_state+84 },
    { Transition::TT_INPUT_ATOM, 117, 117, ms_state+85 },
    { Transition::TT_INPUT_ATOM, 101, 101, ms_state+27 },
    { Transition::TT_INPUT_ATOM, 102, 102, ms_state+28 },
    { Transition::TT_INPUT_ATOM, 108, 108, ms_state+88 },
    { Transition::TT_INPUT_ATOM, 115, 115, ms_state+89 },
    { Transition::TT_INPUT_ATOM, 101, 101, ms_state+29 },
    { Transition::TT_INPUT_ATOM, 101, 101, ms_state+91 },
    { Transition::TT_INPUT_ATOM, 116, 116, ms_state+92 },
    { Transition::TT_INPUT_ATOM, 117, 117, ms_state+93 },
    { Transition::TT_INPUT_ATOM, 114, 114, ms_state+94 },
    { Transition::TT_INPUT_ATOM, 110, 110, ms_state+30 },
    { Transition::TT_INPUT_ATOM, 117, 117, ms_state+96 },
    { Transition::TT_INPUT_ATOM, 110, 110, ms_state+97 },
    { Transition::TT_INPUT_ATOM, 99, 99, ms_state+98 },
    { Transition::TT_INPUT_ATOM, 116, 116, ms_state+99 },
    { Transition::TT_INPUT_ATOM, 105, 105, ms_state+100 },
    { Transition::TT_INPUT_ATOM, 111, 111, ms_state+101 },
    { Transition::TT_INPUT_ATOM, 110, 110, ms_state+31 },
    { Transition::TT_INPUT_ATOM, 97, 97, ms_state+103 },
    { Transition::TT_INPUT_ATOM, 114, 114, ms_state+32 },
    { Transition::TT_EPSILON, 0, 0, ms_state+105 },
    { Transition::TT_INPUT_ATOM_RANGE, 48, 57, ms_state+105 },
    ...
    { Transition::TT_EPSILON, 0, 0, ms_state+33 },
    { Transition::TT_INPUT_ATOM_RANGE, 0, 33, ms_state+34 },
    { Transition::TT_INPUT_ATOM_RANGE, 35, 91, ms_state+34 },
    { Transition::TT_INPUT_ATOM_RANGE, 93, 255, ms_state+34 },
    { Transition::TT_INPUT_ATOM, 92, 92, ms_state+107 },
    { Transition::TT_INPUT_ATOM, 34, 34, ms_state+36 },
    { Transition::TT_EPSILON, 0, 0, ms_state+108 },
    { Transition::TT_INPUT_ATOM, 92, 92, ms_state+108 },
    { Transition::TT_INPUT_ATOM_RANGE, 0, 9, ms_state+35 },
    { Transition::TT_INPUT_ATOM_RANGE, 11, 255, ms_state+35 },
    { Transition::TT_END_OF_INPUT, 0, 0, ms_state+37 }
};
