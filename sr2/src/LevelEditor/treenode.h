...
#ifndef srheader_treenode
#define srheader_treenode
...
public:
	...
	//- creates a SR_TreeNode.</p>
	SR_TreeNode(SR_TreeNode *parent, SR_TreeView *root_tree);
...
public:
	...
	SR_TreeNode *get_current_item() const;
	...
	//: Returns the SR_TreeView this node belongs to.
	SR_TreeView *get_treeview() const;

	//: Returns the parent node.
	SR_TreeNode *get_parent() const;
...
public:
	...
	bool remove_item(SR_TreeNode *node);
	...
	void set_selected(SR_TreeNode *node, bool select = true);
...
//! Implementation:
private:
	SR_TreeNode(const SR_TreeNode &copy) { return; } // disallow copy construction.
	SR_TreeNode_Generic *impl;

	friend class SR_TreeView_Generic;
	friend class SR_TreeNode_Generic;
};
