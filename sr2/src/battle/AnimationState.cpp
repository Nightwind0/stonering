...
void AnimationState::SteelInit      (SteelInterpreter *pInterpreter)
{
	...
	pInterpreter->addFunction("shake","anim", 
							  new SteelFunctor3Arg<AnimationState,SteelType::Handle,SteelType::Handle,double>(this,&AnimationState::shake));
...
void AnimationState::ShakerTask::update(SteelInterpreter* pInterpreter){
	...
	CL_Vec2<float> dir = m_dir.ToScreenVector();
	pick_rand_dir();
}

void AnimationState::ShakerTask::finish()
{
	TimedTask::finish();
