...
// SteelScanner.h generated by reflex at Tue Dec 26 22:23:22 2006
...
public:
    ...
    SteelParser::Token::Type Scan (void **token);
...
private:
    ...
    struct State
    {
        static unsigned int const ms_accept_state_count = 34;

        enum Name
        {
            MAIN = 34,
            STRING_LITERAL_GUTS = 104,
