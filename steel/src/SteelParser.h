...
public:
    ...
    struct Terminal
    {
        ...
        enum Name
        {
            ...
            BAREWORD = 270,
            VAR_IDENTIFIER = 271,
            ARRAY_IDENTIFIER = 272,
            HASHMAP_IDENTIFIER = 273,
            FOR = 274,
            FOREACH = 275,
            WITHIN = 276,
            INCLUDE = 277,
            ...
            FLOAT = 280,
            STRING = 281,
            BINOP_MULT_DIV_MOD = 282,
            BINOP_ADD_SUB = 283,
            BINOP_ASSIGNMENT = 284,
            BOOLEAN = 285,
            INCREMENT = 286,
            DECREMENT = 287,
            POP = 288,
    ...
    struct ParseNonterminal
    {
        ...
        enum Name
        {
            ...
            func_definition = 284,
            func_identifier = 315,
            hashmap_identifier = 319,
            int_literal = 310,
            optionalexp = 304,
            pair = 300,
            pair_list = 298,
            param_definition = 291,
            param_id = 286,
            param_list = 326,
            root = 0,
            statement = 302,
