...
// SteelScanner.h generated by reflex at Mon Jan 11 19:45:27 2010
...
#line 518 "SteelScanner.h"

class SteelScanner : private ReflexCpp_::AutomatonApparatus
{
public:
    ...
    struct Mode
    {
        enum Name
        {
            ...
            START_ = MAIN
        }; // end of enum SteelScanner::Mode::Name
    }; // end of struct SteelScanner::Mode


#line 37 "steel.reflex"
